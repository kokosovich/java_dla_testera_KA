...
public class ZadanieDomowe8 {
    ...
    public static void main(String[] args) {
        ...
        // 1. stworzyć 2 metody abstrakcyjne w klasie Computer: volumeUp (max 100 volume) i volumeDown (min 0 volume)
        // 2. zaimplementować te metody w klasie PC i Laptop: metody przeciążone, będą przyjmowały parametr int
